...
for i in img_path:
    ...
    #print(picture_name)
    picture_newname = picture_name.replace('.jpg', '').replace('E:\Pycharm\Python_Project\Dlib_FaceRecTime\photo\\','')
    #print(picture_newname)
...
endTime = datetime.datetime.now() + datetime.timedelta(minutes=1)  # 每次运行1分钟
while True:
    ...
    if process_this_frame:
        ...
        for i in face_encodings:
            match = face_recognition.compare_faces(known_face_encodings, i, tolerance=0.7)
            if True in match:
